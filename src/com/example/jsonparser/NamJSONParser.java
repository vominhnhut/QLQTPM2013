...
public class NamJSONParser {
	public static ArrayList<DiaDiem> getListDiaDiemFromJsonOject(
	...
	public static ArrayList<BinhLuan> getListBinhLuanFromJsonOject(
			JSONObject jsonObject) throws JSONException {
		...
		for (int i = 0; i < content.length(); i++) {
			...
			binhluan.tenNguoiDang = c
					.getString(StringTagJSON.TAG_TEN_NGUOI_DUNG);
			// binhluan.thoiGianDang =
			// Date.parse(c.getString(StringTagJSON.TAG_THOI_GIAN_DANG));
